...
define('SW_DB_USER', 'manaReporting');
define('SW_DB_PASSWORD', 'eveA0njJ7pYsFC1M');
define('SW_DB_HOST', '127.0.0.1');
define('SW_DB_DATABASE', 'manaDB');
}
