...
#
#   GRANT SELECT, FILE, CREATE TEMPORARY TABLES, CREATE VIEW, SHOW VIEW ON *.* TO 'manaReporting'@'localhost' IDENTIFIED BY 'eveA0njJ7pYsFC1M' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;
#
#   FLUSH PRIVILEGES;
...
--
  ...
  INSERT INTO `LabelLanguage` VALUES('approveLeave', 0, 'Approve Leave', 0);
  INSERT INTO `LabelLanguage` VALUES('approveLeave', 1, 'නිවාඩු අනුමතකිරීම', 0);
  INSERT INTO `LabelLanguage` VALUES('byClass', 0, 'by Class', 0);
  INSERT INTO `LabelLanguage` VALUES('byClass', 1, 'පන්ති මට්ටමින්', 0);
  INSERT INTO `LabelLanguage` VALUES('byTeacher', 0, 'by Teacher', 0);
  INSERT INTO `LabelLanguage` VALUES('byTeacher', 1, 'ගුරුවරයාගේ නමින්', 0);
  INSERT INTO `LabelLanguage` VALUES('chooseOption', 0, 'Choose Option', 0);
  INSERT INTO `LabelLanguage` VALUES('chooseOption', 1, 'විකල්පය තෝරගන්න', 0);
  ...
  INSERT INTO `LabelLanguage` VALUES('createTimetableByTeacher', 0, 'Create Timetable by Teacher', 0);
  INSERT INTO `LabelLanguage` VALUES('createTimetableByTeacher', 1, 'ගුරුවරයා විසින් කාලසටහන සැකසුම', 0);
  INSERT INTO `LabelLanguage` VALUES('createTimeTableForm', 0, 'Create TimeTable Form', 0);
  INSERT INTO `LabelLanguage` VALUES('createTimeTableForm', 1, 'කාලසටහන් නිර්මාණය කිරීමේ පෝරමය ', 0);
  INSERT INTO `LabelLanguage` VALUES('date', 0, 'Date', 0);
  INSERT INTO `LabelLanguage` VALUES('date', 1, 'දිනය', 0);
  ...
  INSERT INTO `LabelLanguage` VALUES('friday', 0, 'Friday', 0);
  INSERT INTO `LabelLanguage` VALUES('friday', 1, 'සිකුරාදා', 0);
  INSERT INTO `LabelLanguage` VALUES('grade', 0, ' Grade', 0);
  INSERT INTO `LabelLanguage` VALUES('grade', 1, 'වසර', 0);
  INSERT INTO `LabelLanguage` VALUES('interval', 0, 'INTERVAL', 0);
  INSERT INTO `LabelLanguage` VALUES('interval', 1, 'විවේක කාලය', 0);
  ...
  INSERT INTO `LabelLanguage` VALUES('monday', 0, 'Monday', 0);
  INSERT INTO `LabelLanguage` VALUES('monday', 1, 'සදුදා', 0);
  INSERT INTO `LabelLanguage` VALUES('name', 0, 'Name', 0);
  INSERT INTO `LabelLanguage` VALUES('name', 1, 'සිදුවීම', 0);
  INSERT INTO `LabelLanguage` VALUES('prizegiving', 0, 'Prize Giving Ceremony', 0);
  INSERT INTO `LabelLanguage` VALUES('prizegiving', 1, 'ත්‍යාග ප්‍රධානෝත්සවය', 0);
  ...
  INSERT INTO `LabelLanguage` VALUES('subject', 0, 'Subject', 0);
  INSERT INTO `LabelLanguage` VALUES('subject', 1, 'විෂය', 0);
  INSERT INTO `LabelLanguage` VALUES('substituteTeacherForm', 0, 'Substitute Teacher Form', 0);
  INSERT INTO `LabelLanguage` VALUES('substituteTeacherForm', 1, 'ගුරුවරුන්  ආදේශ කිරීමේ පෝරමය', 0);
  INSERT INTO `LabelLanguage` VALUES('teacherday', 0, 'Teacher''s Day', 0);
  INSERT INTO `LabelLanguage` VALUES('teacherday', 1, 'ගුරු දිනය', 0);
  INSERT INTO `LabelLanguage` VALUES('teachersName', 0, 'Teacher''s Name', 0);
  INSERT INTO `LabelLanguage` VALUES('teachersName', 1, 'ගුරුවරයාගේ නම', 0);
  INSERT INTO `LabelLanguage` VALUES('th', 0, 'T', 0);
  INSERT INTO `LabelLanguage` VALUES('th', 1, '', 0);
  INSERT INTO `LabelLanguage` VALUES('thursday', 0, 'Thursday', 0);
  INSERT INTO `LabelLanguage` VALUES('thursday', 1, 'බ්‍රහස්පතින්දා', 0);
  INSERT INTO `LabelLanguage` VALUES('time', 0, 'Time', 0);
  INSERT INTO `LabelLanguage` VALUES('time', 1, 'වේලාව', 0);
  INSERT INTO `LabelLanguage` VALUES('timetables', 0, 'Timetables', 0);
  INSERT INTO `LabelLanguage` VALUES('timetables', 1, 'කාලසටහන', 0);
  INSERT INTO `LabelLanguage` VALUES('tu', 0, 'T', 0);
  INSERT INTO `LabelLanguage` VALUES('tu', 1, 'අ', 0);
  INSERT INTO `LabelLanguage` VALUES('tuesday', 0, 'Tuesday', 0);
  INSERT INTO `LabelLanguage` VALUES('tuesday', 1, 'අගහරුවදා', 0);
  ...
  INSERT INTO `LabelLanguage` VALUES('wednesday', 0, 'Wednesday', 0);
  INSERT INTO `LabelLanguage` VALUES('wednesday', 1, 'බදාදා', 0);
